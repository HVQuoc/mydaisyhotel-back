...
import com.hoangquoc.mydaisyhotel.exception.PhotoRetrievalException;
...
import com.hoangquoc.mydaisyhotel.service.BookingService;
...
public class RoomController {
    ...
    public ResponseEntity<Optional<RoomResponse>> getRoomById(@PathVariable Long roomId) {
        ...
        }).orElseThrow(() -> new ResourceNotFoundException("Room not found by id"));
    }
    ...
    private RoomResponse getRoomResponse(Room room){
        // create a single room response by get
        // all the related data of it
...
//                .toList();
        ...
        if (photoBlob != null) {
            try {
                ...
                throw new PhotoRetrievalException("Photo retrieving exception");
            }
        }
